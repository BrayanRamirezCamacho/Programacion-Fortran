...
REAL(rango):: nom1real, nom1imag, nom2real, nom2imag, resreal, resimag, denom
CHARACTER(len=20):: OPERACION
INTEGER:: OPCION
REAL, PARAMETER:: pi=3.14159265359
...
PRINT*, "Las soluciones de su ecuación son:"
PRINT*, "x1=",x1," y ","x2=",x2
PRINT*, "(Este programa solo calcula raíces reales)"
